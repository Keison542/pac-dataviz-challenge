    ...
    <div className="w-full">
      ...
      <div className="mb-4 grid grid-cols-4 gap-2">
        <div className="text-center p-2 bg-cyan-50 rounded-lg">
          <div className="text-sm font-bold text-cyan-700">{stats.averageValue.toFixed(2)}{unit}</div>
          <div className="text-[10px] text-slate-500">Average</div>
        </div>
        <div className="text-center p-2 bg-amber-50 rounded-lg">
          <div className="text-sm font-bold text-amber-700">{stats.maxValue.toFixed(2)}{unit}</div>
          <div className="text-[10px] text-slate-500">Peak ({stats.maxYear || '—'})</div>
        </div>
        <div className="text-center p-2 bg-blue-50 rounded-lg">
          <div className="text-sm font-bold text-blue-700">{stats.minValue.toFixed(2)}{unit}</div>
          <div className="text-[10px] text-slate-500">Lowest ({stats.minYear || '—'})</div>
        </div>
        <div className="text-center p-2 bg-emerald-50 rounded-lg">
          <div className={`text-sm font-bold ${stats.percentChange > 0 ? 'text-red-600' : 'text-green-600'}`}>

    ...
    <div className="text-center mb-12 relative z-10">
      ...
      <div className="text-[0.7rem] text-slate-400 mt-4">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          ...
          <a href="https://stats.pacificdata.org/vis?lc=en&df[ds]=SPC2&df[id]=DF_CLIMATE_CHANGE&df[ag]=SPC&df[vs]=1.0&av=true&dq=A.ST_ANOM.&pd=,&to[TIME_PERIOD]=false" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-600 transition">Surface Temperature</a>

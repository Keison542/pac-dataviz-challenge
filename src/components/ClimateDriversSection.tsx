...
export function ClimateDriversSection({ dataMap, tempTrend, chartWidth, selectedCountry }: ClimateDriversSectionProps) {
  ...
  return (
    <>
      ...
      <p>Fig 2:This chart isolates long-term {getchartLabel(chartLabel).toLowerCase()} anomalies in {selectedCountry}, showing whether a consistent climate signal is emerging.</p>
    </>
